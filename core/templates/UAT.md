...
- This section feeds directly into /qgsd:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /qgsd:plan-phase --gaps with root causes
...
**Creation:** When /qgsd:verify-work starts new session
