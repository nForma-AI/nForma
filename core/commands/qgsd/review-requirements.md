...
argument-hint: [--batch] [--dry-run] [--category="Category Name"] [--ids=REQ-01,REQ-02]
allowed-tools:
  - Read
  - Write
  - Edit
...
<execution_context>
@__NF_PATH__/workflows/review-requirements.md
</execution_context>

<process>
Execute the review-requirements workflow from @__NF_PATH__/workflows/review-requirements.md end-to-end.
Pass through all --flags from arguments:
  --batch         Fully autonomous mode — auto-apply safe fixes, skip prompts
