...
// Verify count (18 keys after L2 collapse — STRUCT-01)
assert.strictEqual(LAYER_KEYS.length, 18, 'LAYER_KEYS must have exactly 18 entries');
...
assert.strictEqual(new Set(LAYER_KEYS).size, 18, 'No duplicate keys');
