...
// Requirement: Observe handlers catch all errors internally and return status: error with a descriptive error string. No handler throws — the dispatch layer Promise.allSettled is a safety net, not the primary error 
...
test('OBS-12 — Bool: structural verification', () => {
