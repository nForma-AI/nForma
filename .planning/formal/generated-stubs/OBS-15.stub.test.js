...
// Requirement: Stateful observe handlers persist their cursor in .planning/ as JSON with a last_checked ISO8601 field. State writes use atomic write (write to temp file + rename) to prevent corruption.
...
test('OBS-15 — Bool: structural verification', () => {
