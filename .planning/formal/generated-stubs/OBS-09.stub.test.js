...
// Requirement: Observe handlers return the standard schema { source_label, source_type, status: ok|error, issues: Array, error?: string } with all issue fields populated (id, title, severity, url, age, created_at, m
...
test('OBS-09 — Bool: structural verification', () => {
