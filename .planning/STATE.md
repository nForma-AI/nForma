...
| 111 | add max_turns=100 to all qgsd-quorum-slot-worker Task dispatch sites | 2026-02-26 | {commit_hash} | Pending | [111-add-max-turns-100-to-all-qgsd-quorum-slo](./quick/111-add-max-turns-100-to-all-qgsd-quorum-slo/) |
