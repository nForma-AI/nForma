...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| v0.30-07-01-01 | 01 | 1 | PARA-01 | unit | `npx vitest run -x` | TBD | ⬜ pending |
| v0.30-07-01-02 | 01 | 1 | PARA-01 | integration | `npx vitest run -x` | TBD | ⬜ pending |
| v0.30-07-02-01 | 02 | 2 | PARA-02 | unit | `npx vitest run -x` | TBD | ⬜ pending |
