# Requirements Archive: v0.32 Documentation & README Overhaul
...
- [x] **VIS-01**: All TUI screenshots regenerated via VHS tape automation after README structural changes
- [x] **VIS-02**: VHS tape hardened for CI reliability (zsh shell, explicit PATH export, CLAUDECODE unset)
...
| VIS-01 | v0.32-04 | Complete |
| VIS-02 | v0.32-04 | Complete |
