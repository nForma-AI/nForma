...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| v0.31-01-01-01 | 01 | 1 | VALID-01 | unit | `npx vitest run hooks/config-loader.test.js` | TBD | pending |
| v0.31-01-01-02 | 01 | 1 | VALID-01 | integration | `echo '{}' \| node hooks/nf-prompt.js 2>&1` | TBD | pending |
| v0.31-01-02-01 | 02 | 2 | PRIO-01 | unit | `npx vitest run hooks/config-loader.test.js` | TBD | pending |
| v0.31-01-02-02 | 02 | 2 | PRIO-01 | integration | `node bin/install.js --claude --global` | TBD | pending |
...
|------|-------|-----------|------|------|-----------------|
| 1 | 2 (Plan 01) | `npx vitest run` | TBD | TBD | pending |
| 2 | 2 (Plan 02) | `npx vitest run` | TBD | TBD | pending |
